    ...
    function checkIcons(xx, yy)
    {
        ...
        if (xx > icons[3].pos[0] && xx < icons[3].pos[0] + (k * 5) && yy > icons[3].pos[1] - (k * 3) && yy < icons[3].pos[1] + (k * 3))
        {
           ...
           if(modal.style.display == "block") {
                ...
                p.innerHTML = 'Enjoy Your GAME And Keep Support For Me<br/>Developed By Missari<br/>Thank you!'; 
...
ctx.fillText("Next Boost in " + Math.round  (nextwave) , c.width/10, c.height/22);        
